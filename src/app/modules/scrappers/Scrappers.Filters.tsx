...
const ScrappersFilters = () => {
  ...
  const applyFilters = () => {
    ...
    scrapperFilters.status = tempStatus;
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    if (e.target.checked) {
      setTempStatus(e.target.name === 'suspended' ? Statuses.Suspended : e.target.name === 'paused' ? Statuses.Paused : Statuses.Live)
    } else {
      setTempStatus(undefined)
    }
  }
...
export default ScrappersFilters
