...
const ScrapperSearch = () => {
  ...
  const [searchText, setSearchText] = useState(scrapperFilters.q)
  ...
  const fetchData = (text?: string) => {
    scrapperFilters.q = text;
    scrapperFilters.pageNo = 1;
    delete scrapperFilters.total;
    dispatch(
      scrappersRedux.actions.getScrappers(scrapperFilters)
    )
  }
